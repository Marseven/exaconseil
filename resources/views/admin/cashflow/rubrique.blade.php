...
@section('content')
        ...
        <div class="toolbar" id="kt_toolbar">
            ...
            <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
                ...
                <div data-kt-swapper="true" data-kt-swapper-mode="prepend"
                    ...
                    <!--begin::Title-->
                    <h1 class="d-flex align-items-center text-dark fw-bold my-1 fs-3">Rubrique de Caisse</h1>
                    <!--end::Title-->
                    <!--begin::Separator-->
                    ...
                    <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-1">
                        ...
                        <!--end::Item-->
                        <!--begin::Item-->
                        <li class="breadcrumb-item text-dark">Liste des rubriques de caisse</li>
                        <!--end::Item-->
                    </ul>
                    <!--end::Breadcrumb-->
                </div>
                ...
                <div class="card">
                    ...
                    <div class="card-header border-0 pt-6">
                        ...
                        <div class="card-title">
                            <h2>Liste des rubriques Caisses</h2>
                        </div>
                        <!--begin::Card title-->
                        <!--begin::Card toolbar-->
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <button class="btn btn-xs btn-danger" data-bs-toggle="modal"
                                                data-bs-target="#cardModalCenter{{ $rubrique->id }}">
                                                Supprimer
                                            </button>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabelOne">Ajouter une rubrique</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close">
                        <i class="lni lni-close"></i>
                    </button>
                </div>
                <form action="{{ url('admin/create/rubrique/') }}" method="POST">
                    @csrf
    ...
    @foreach ($rubriques as $rubrique)
        <div class="modal fade" id="cardModal{{ $rubrique->id }}" tabindex="-1" role="dialog"
            aria-labelledby="exampleModalLabelOne" aria-hidden="true">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="exampleModalLabelOne">Mettre à jour la rubrique</h5>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close">
                            <i class="lni lni-close"></i>
                        </button>
                    </div>
                        ...
                        <div class="modal-body">
                            ...
                            <div class="mb-3">
                                <div class="input-style-1">
                                    <label>Nom</label>
                                    <input class="form-control" name="name" type="text"
                                        placeholder="Nom de la caisse" value="{{ $rubrique->name }}" />
                                </div>
                            </div>
                        </div>
                        <div class="modal-footer">
    ...
    @foreach ($rubriques as $rubrique)
        <!-- Modal -->
        <div class="modal fade" id="cardModalCenter{{ $rubrique->id }}" tabindex="-1" role="dialog"
            ...
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        ...
                        <form method="POST" action="{{ url('admin/update/rubrique' . $rubrique->id) }}">
                            @csrf
