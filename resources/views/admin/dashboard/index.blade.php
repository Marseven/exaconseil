                                    ...
                                    <div class="fs-2hx fw-bold text-gray-800 text-center mb-13">
                                        <span class="me-2">Try our all new Enviroment with
                                            ...
                                            <span class="position-relative d-inline-block text-danger">
                                                <a href="../../demo13/dist/pages/user-profile/overview.html"
                                    ...
                                    <div class="tab-pane fade" id="kt_chart_widget_8_week_tab" role="tabpanel">
                                        ...
                                        <div class="mb-5">
                                            ...
                                            <div class="d-flex align-items-center mb-2">
                                                ...
                                                <span class="badge badge-light-success fs-base">
                                                    <i
                                                        class="ki-outline ki-arrow-up fs-5 text-success ms-n1"></i>4,8%</span>
                                            </div>
                                            <!--end::Statistics-->
                                            <!--begin::Description-->
                                    ...
                                    <div class="col-sm-6">
                                        ...
                                        <div class="d-flex flex-column h-100">
                                            ...
                                            <div class="d-flex flex-stack mt-auto bd-highlight">
                                                ...
                                                <!--end::Users group-->
                                                <!--begin::Actions-->
                                                <a href="../../demo13/dist/apps/projects/project.html"
                    ...
                    <div class="col-xl-8">
                        ...
                        <div class="card card-flush h-md-100">
                            ...
                            <div class="card-header pt-7">
                                ...
                                <!--begin::Toolbar-->
                                <div class="card-toolbar">
                                    <a href="../../demo13/dist/apps/ecommerce/catalog/add-product.html"
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td class="text-end pe-0">
                                                    ...
                                                    <span class="badge badge-light-success fs-base">
                                                        <i
                                                            class="ki-outline ki-arrow-up fs-5 text-success ms-n1"></i>9.2%</span>
                                                    <!--end::Label-->
                                                </td>
