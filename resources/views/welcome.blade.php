    ...
    <div
        ...
        <div class="max-w-7xl mx-auto p-6 lg:p-8">
            <div class="h-16 flex justify-center">
                <img src="{{ asset('media/logos/logo_eaceia.png') }}" alt="">
            </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6 lg:gap-8">
                    <a href="{{ route('admin-dashboard') }}"
                        ...
                        <div>
                            <div
                                ...
                                <img src="{{ asset('media/logos/logo_eac.png') }}" alt="">
                            </div>

                            <h2 class="mt-6 text-xl font-semibold text-gray-900 dark:text-white">Expertise Akom conseil
                            </h2>
                    ...
                    <a href="{{ route('admin-dashboard') }}"
                        ...
                        <div>
                            <div
                                class="h-16 w-16 bg-red-50 dark:bg-red-800/20 flex items-center justify-center rounded-full">
                                <img src="{{ asset('media/logos/logo_eia.png') }}" alt="">
                            </div>

                            <h2 class="mt-6 text-xl font-semibold text-gray-900 dark:text-white">EIA</h2>
